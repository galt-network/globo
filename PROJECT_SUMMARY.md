...
# Covers connection_test.cljs + message_arcs_test.cljs + hexholds_test.cljs + hud_views_test.cljs + user_name_test.cljs + user_figure_test.cljs (74 tests / 323 assertions)
```
